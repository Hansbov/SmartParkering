...
export const UserExtraDeleteDialog = (props: IUserExtraDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="smartParkingApp.userExtra.delete.question">
        <Translate contentKey="smartParkingApp.userExtra.delete.question" interpolate={{ id: userExtraEntity.id }}>
