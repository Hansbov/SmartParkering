...
class AddressResourceIT {
     ...
     *
     * @see smartparking.repository.search.AddressSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().streetAddress(DEFAULT_STREET_ADDRESS).postalCode(DEFAULT_POSTAL_CODE).city(DEFAULT_CITY);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().streetAddress(UPDATED_STREET_ADDRESS).postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY);
        return address;
    }
    ...
    void putNewAddress() throws Exception {
        ...
        updatedAddress.streetAddress(UPDATED_STREET_ADDRESS).postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.streetAddress(UPDATED_STREET_ADDRESS).city(UPDATED_CITY);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.streetAddress(UPDATED_STREET_ADDRESS).postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY);
    ...
    void searchAddress() throws Exception {
        ...
        // Initialize the database
        addressRepository.saveAndFlush(address);
        when(mockAddressSearchRepository.search(queryStringQuery("id:" + address.getId()))).thenReturn(Collections.singletonList(address));
