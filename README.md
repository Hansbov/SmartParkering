...
To use Elasticsearch in development follow these instructions:
...
```
Go to [Using Elasticsearch][] for more details.

## Building for production

### Packaging as jar

To build the final jar and optimize the SmartParking application for production, run:
